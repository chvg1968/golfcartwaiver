document.getElementById('waiverForm').addEventListener('submit', function(e) {
    ...
    if (isValid) {
        ...
        const AIRTABLE_API_KEY = 'your_new_api_key_here';
        const AIRTABLE_BASE_ID = 'your_new_base_id_here';
        const AIRTABLE_TABLE_NAME = 'your_new_table_name_here';
        ...
        .then(data => {
            ...
            const resendApiKey = 'your_resend_api_key_here';
