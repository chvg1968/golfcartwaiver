    ...
    try {
      ...
      pdfContainer.innerHTML = `
        ...
        <div style="margin-bottom: 20px;">
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="vertical-align: top; padding: 5px;">
                <p style="font-size: 10px; margin: 0; color: red;">
                  I acknowledge that it is strictly forbidden for an individual without a valid driver's license to operate the golf cart.
                </p>
              </td>
              <td style="width: 80px; vertical-align: top; padding: 5px;">
                <div>
        ...
        <div style="margin-top: 15px; font-size: 10px;">
          <p>I am responsible for the possession/control of vehicle keys when not in use.</p>
          
          <p style="color: red; font-weight: bold; margin-top: 10px;">
            Golf carts are a motorized vehicle and driving or riding in these vehicles can lead to serious injury, property damage and even death.
          </p>
          
          <p style="margin-top: 10px;">
            The use of these vehicles is for transportation and use should conform with all rules & regulations of the Bahia Beach Resort Community.
          </p>
          
          <p style="color: red; font-weight: bold; margin-top: 10px;">
            No excessive speeding, joy riding, golf course or golf course path riding, beach, sand or off-road riding, disregard of traffic signs, or any type of unreasonable activity with the golf cart will be tolerated by the development. I will limit the number of golf cart occupants to the number of occupants recommended by the golf cart's manufacturer.
          </p>
          
          <p style="margin-top: 10px;">
            In no way should the use of this vehicle be seen as an endorsement by the unit owner, property manager or Bahia Beach of a form of recreation or fun.
          </p>
