...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    const emailHtml = `
      ...
      <p><strong>PDF Link:</strong> <a href="${pdfLink}">Descargar PDF del Waiver</a></p>
      
      <hr />
      <p><small>Nota: Este es un correo de prueba enviado a una dirección verificada.</small></p>
