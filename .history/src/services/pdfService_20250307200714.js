...
export async function generatePDF(formElement) {
  try {
    ...
    pdfContainer.style.width = "7.5in";
    ...
    pdfContainer.innerHTML = `
        ...
        <div style="font-size: 10px; margin-bottom: 15px; text-align: justify;">
          <p style="margin-bottom: 8px; line-height: 1.3;">
          ...
          <p style="font-weight: bold; margin-top: 8px; line-height: 1.3;">
        ...
        <div style="margin-bottom: 20px;">
          <table style="width: 100%; border-collapse: collapse;">
              ...
              <td style="width: 80px; vertical-align: top; padding: 5px;">
                <div>
                  ...
                  <div style="border: 1px solid black; width: 60px; height: 20px; margin-top: 2px; text-align: center; line-height: 20px; background-color: #f9f9f9; display: flex; align-items: center; justify-content: center;">
                    <span style="font-size: 12px;">${initialValues[0] || ""}</span>
                  </div>
                </div>
              </td>
            </tr>
            <tr>
              <td style="width: 20px; vertical-align: top; padding: 5px;">
                <div style="border: 1px solid black; width: 15px; height: 15px; text-align: center; line-height: 15px;">✔️</div>
              </td>
              <td style="vertical-align: top; padding: 5px;">
                <p style="font-size: 10px; margin: 0;">
              ...
              <td style="width: 80px; vertical-align: top; padding: 5px;">
                <div>
                  <span style="font-size: 10px; font-weight: bold;">INITIAL:</span>
                  <div style="border: 1px solid black; width: 60px; height: 20px; margin-top: 2px; text-align: center; line-height: 20px; background-color: #f9f9f9; display: flex; align-items: center; justify-content: center;">
                    <span style="font-size: 12px;">${initialValues[1] || ""}</span>
                  </div>
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td style="width: 80px; vertical-align: top; padding: 5px;">
                <div>
                  <span style="font-size: 10px; font-weight: bold;">INITIAL:</span>
                  <div style="border: 1px solid black; width: 60px; height: 20px; margin-top: 2px; text-align: center; line-height: 20px; background-color: #f9f9f9; display: flex; align-items: center; justify-content: center;">
                    <span style="font-size: 12px;">${initialValues[2] || ""}</span>
                  </div>
                </div>
              </td>
            </tr>
        ...
        <div style="margin-top: 30px; width: 90%; margin-left: auto; margin-right: auto;">
          <p style="font-size: 10px; margin-bottom: 5px; font-weight: bold;">Signature:</p>
          <div style="border: 1px solid black; height: 70px; width: 100%; position: relative; background-color: #fafafa;">
          ...
          <div style="display: flex; margin-top: 20px; font-size: 10px; justify-content: space-between;">
            <div style="flex: 1; padding-right: 10px;">
              <p style="margin-bottom: 8px;"><b>Guest Name:</b> ${fullName}</p>
              <p style="margin-bottom: 8px;"><b>License:</b> ${license}</p>
            </div>
            <div style="flex: 1; padding-left: 10px;">
              <p style="margin-bottom: 8px;"><b>Issuing State:</b> ${issuingState}</p>
              <p style="margin-bottom: 8px;"><b>Address:</b> ${address}</p>
            </div>
          </div>
          
          <p style="font-size: 10px; margin-top: 20px; text-align: center;"><b>Date:</b> ${signatureDate}</p>
        </div>
      `;

    // Opciones para html2pdf
    const options = {
      margin: [15, 20, 15, 20], // [top, right, bottom, left]
